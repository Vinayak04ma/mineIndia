          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between">
                {['minerals', 'production', 'energy', 'materials', 'review'].map((step, index) => (
                  <div key={step} className="flex items-center">
                    <div 
                      className={`flex items-center justify-center w-8 h-8 rounded-full ${
                        activeTab === step ? 'bg-primary text-white' : 'bg-muted'
                      }`}
                    >
                      {index + 1}
                    </div>
                    <div className={`text-sm ml-2 ${activeTab === step ? 'font-medium' : 'text-muted-foreground'}`}>
                      {step.charAt(0).toUpperCase() + step.slice(1)}
                    </div>
                    {index < 3 && (
                      <div className="w-16 h-px bg-muted mx-2"></div>
                    )}
                  </div>
                ))}
              </div>
            ...
            {activeTab === 'minerals' && (
              <div className="mb-8">
                ...
                <div className="mt-6 flex justify-end">
                  <Button 
                    type="button" 
                    disabled={formData.selectedMinerals.length === 0}
                    onClick={() => setActiveTab('production')}
                  >
                    Next: Production Data
                  </Button>
                </div>
              </div>
            )}
            ...
            {/* Add more sections for Energy, Materials, etc. */}
            ...
            {activeTab === 'review' && (
              <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <Card>
                      <CardHeader className="bg-muted/50">
                        <CardTitle>Selected Minerals</CardTitle>
                      </CardHeader>
                      <CardContent className="pt-4">
                        {formData.selectedMinerals.length > 0 ? (
                          ...
                          <p className="text-muted-foreground">No minerals selected</p>
                        )}
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      <CardHeader className="bg-muted/50">
                        <CardTitle>Production & Operational Data</CardTitle>
                      </CardHeader>
                      <CardContent className="pt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <p className="text-sm text-muted-foreground">Annual Production</p>
                          <p>{formData.annualProduction || '-'} t/yr</p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground">Operating Hours</p>
                          <p>{formData.operatingHours || '-'} h/yr</p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground">Yield/Efficiency</p>
                          <p>{formData.yieldEfficiency || '-'}%</p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground">Technology Type</p>
                          <p>{formData.technologyType || '-'}</p>
                        </div>
                      </CardContent>
                    </Card>

                    {/* Add more review cards for other sections */}
                    
                    <div className="text-sm text-muted-foreground">
                      <p>Please review all your data before submitting. You can go back to any section to make changes.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-between mt-6">
                  ...
                  <Button type="submit">Generate Analysis Report</Button>
                </div>
              </div>
            )}
          </form>
